...
END)AS ESTADOS   FROM [022BDCOMUN].DBO.RESERVA_CAB AS C
 ...
 C.SOLICITANTE=T.TCLAVE WHERE TCOD='12' AND C.ESTADO='00' 
 AND C.CENTROCOSTO NOT LIKE '000017'",$link);
?>
<thead>
<tr class="info">
<th>NRORESERVA</th>
...
<td><?php $reserva->ReservaVacia($reg['NRORESERVA'],$_SESSION['id_usuario']) ?></td>
</tr>
